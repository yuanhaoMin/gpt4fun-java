...
public class ChamberPathConstants {
    ...
    public static final String CHAMBER_CHAT_COMPLETION_CHAT_COMPLETION_WITHOUT_STREAM_PATH = "/messages";
    public static final String CHAMBER_CHAT_COMPLETION_CHAT_COMPLETION_WITH_STREAM_PATH = "/stream-messages";
    ...
    public static final String CHAMBER_COMPLETION_COMPLETION_WITH_STREAM_PATH = "/stream-message";
    public static final String CHAMBER_COMPLETION_UPDATE_COMPLETION_PATH = "/message";
